    ...
    return(
        <>
            <div className="relative mb-3" ref={dropdownRef}>
                <button className="bg-button w-full p-4 rounded-xl text-start flex items-center"
                ...
                <div className={`absolute rounded-xl top-full mt-2 w-full bg-button ${menuOpen ? "flex" : "hidden"} flex-col max-h-[280px] overflow-y-scroll scrollbar z-[50]`} id="track-dropdown">
